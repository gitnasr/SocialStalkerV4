const PrivacyPage = () => {
  return (
    <div className="container prose prose-invert">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to SocialStalker.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to SocialStalker, accessible from{" "}
            <a
              href="https://ss.gitnasr.com/"
              rel="external nofollow noopener noreferrer"
              target="_blank"
            >
              https://ss.gitnasr.com/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: gitnasr@proton.me</li>
      </ul>
    </div>
  );
};
